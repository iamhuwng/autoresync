...
- `tasks/0056a-prd-listening-upload-session-bridge.md` - Approved planning bridge for backend-issued Listening upload sessions/assets and the `temp/listening-audio/` to `temp/listening/` transition; deployed/current S0 proof is recorded, while PRD-0056A implementation remains blocked pending an approved implementation packet and its own gates.
...
- [ ] 4.0 Establish minimum registry-backed draft-audio retention foundation
  ...
  - [ ] 4.4 Add minimal asset states required for safe draft retention: `temp`, `committing`, `committed`, and `pending-delete`. Do not add fields or paths not specified by the approved storage child PRD plan/text.
  ...
  - [ ] 4.6 Consume PRD-0056A authenticated upload-session creation and add only PRD-0058-approved lifecycle/session continuation:
