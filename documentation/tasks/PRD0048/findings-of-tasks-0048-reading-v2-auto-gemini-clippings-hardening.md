...
- Added architecture note `documentation/architecture/changelog/reading-v2-auto-source-ledger-and-repair.md` covering ledger authority, prompt contract, verifier diagnostics, bounded repair loop, operational knobs, harness modes, and required verification evidence.
