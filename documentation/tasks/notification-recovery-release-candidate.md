...
Wrangler authentication is currently valid for account `e41db829dabe9993f03674afdfd56510`. The deployed `luyentap-notification-command` readback lists 100% versions `e1650eb9-310c-488c-a412-280f1fc5c6bb` (2026-09-19), `ade7fd99-b04d-40b6-902f-f5358f5b790a` (secret-triggered, 2026-09-19), and `6df57eec-587b-44b5-9a59-6d65ba13a70a` (2026-09-23). This does not prove that the current candidate is deployed or that its bindings/secrets match. Read back the active script, bindings, cron triggers, and secret names immediately before release.

## Product and release gates

1. Verify the existing Cloudflare authentication, `FIREBASE_WEB_API_KEY` secret, and Firestore-capable role for `notification-command-runtime@temp-a1437.iam.gserviceaccount.com`; read back Worker version, bindings, and cron triggers after deployment. Current secret/IAM checks are not yet recorded as release proof.
