...
- [ ] 2.0 Add source upload/version creation flow
  ...
  - [ ] 2.5 Require teacher/admin rights confirmation before upload or before publish according to final UX decision.
...
- [ ] 3.0 Spike and select backend PDF excerpt engine
  ...
  - [ ] 3.8 Record the selected engine, rejection rationale for alternatives, and deployment constraints in findings.
...
- [ ] 8.0 Add observability and operational safeguards
  ...
  - [ ] 8.4 Update findings with source-delivery owner paths, engine decision, and unresolved risks.
