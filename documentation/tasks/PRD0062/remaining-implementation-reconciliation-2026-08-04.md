...
- **#102 / 42A**, **#103 / 42B**, **#104 / 42C**, **#106 / 44**, and **#107 / 39D** are
  ...
  through merge `5ac9ba9b`. **#108 / 39C, #109 / 40A, and #110 / 40C are
  locally accepted at `94ddf39a`, `63b9981c`, and `b4d95e30`; **#112 / 41A is
  locally accepted at `1c30bf19` and the requested serialized slice is complete**;
  #127 source conformance remains an
...
| **#108 / 39C** — §9 authoritative affected-context snapshot and review | `IMPLEMENTED_LOCAL_VERIFIED_ACCEPTED` | Commit `94ddf39a` implements immutable complete-context fingerprint/TTL snapshots, authoritative persistence/indexes, read projection, ownership denial, teacher review, and inactive fragment with 15 focused tests plus changed-file type/lint proof. | No #108 product reimplementation remains. Delivery mutation stays with #109–#117; generated/active rules and remote/browser proof stay with #118/#130/#134. | accepted #106/#107 plus closed #67/#68/#71/#101 → #109, #112–#115, #118 | Bounded local proof only; no generated-rules, authenticated-browser, emulator, or deployed claim. |
| **#109 / 40A** — §§9, 11 durable update action ledger | `IMPLEMENTED_LOCAL_VERIFIED_ACCEPTED` | Commit `63b9981c` implements snapshot-bound explicit commands, idempotency-first replay, bounded audit, monotonic CAS states, ownership denial, browser seam, repository/indexes, and inactive `40A.json`. | No #109 reimplementation remains. Case mutations stay in #111–#114; finalization stays #110; generated/active rules stay #118. | #108 → #110–#116, #118 | Bounded local service/repository/rules/browser proof only; deployed drill remains downstream. |
| **#110 / 40C** — §9 persistent case-specific post-commit notifications | `IMPLEMENTED_LOCAL_VERIFIED_ACCEPTED` | Commit `b4d95e30` adds the shared committed-only finalizer, authoritative destination plans, #100 deterministic emitter adapter, partial retry, zero-notification filtering, and shared teacher announcements. Existing notification regressions pass 41/41. | No #110 reimplementation remains. Case handlers provide committed plan facts; deployed/browser proof remains with downstream owners. | #109 + closed #100 → #111–#114, #117, #124 | Bounded local finalizer/adapter/announcement proof; no deployed or authenticated-browser claim. |
...
| **#112 / 41A** — §9 display-only, reorder, and supported regrade | `IMPLEMENTED_LOCAL_VERIFIED_ACCEPTED` | Commit `1c30bf19` implements the shared non-redo executor, deterministic projection/evaluation adapters, no-redo reorder semantics, objective immutable regrade history, rubric review queuing, retained-move scheduling, and explicit move-in/out delegation. | No #112 local product reimplementation remains. Authenticated-browser/deployed proof stays downstream; moved-out/in execution remains with #113/#114. | #108 + #109 + #110 → #116, #129 | 20 focused case/projection tests, 51 existing evaluation regressions, changed-file type/lint proof; no browser/deployed claim. |
...
- **S2 — launch and adapters:** #104/#106/#107/#108 are locally accepted; #108 freezes one immutable complete-context snapshot.
