...
> **Obsolete as of 2026-07-05:** Reading V1 creation/runtime is retired. Current authority: [Retired Features Current State](../architecture/retired-features-current-state.md). Historical content below is retained as implementation history; unfinished Reading V1 work is cancelled by feature retirement.
