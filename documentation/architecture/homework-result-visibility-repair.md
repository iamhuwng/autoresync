...
git diff --check -- src/services/resultOwnershipResolver.ts src/services/resultOwnershipResolver.test.ts src/services/testResults.service.ts src/services/testResults.service.test.ts documentation/architecture/homework-result-visibility-repair.md
```
