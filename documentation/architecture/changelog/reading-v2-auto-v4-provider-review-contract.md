...
Changelog ID: `CL-20260524-READING-V2-AUTO-V4-PROVIDER-REVIEW-CONTRACT`
Moved from: `documentation/architecture/reading-v2-auto-v4-provider-review-contract.md`
...
Teacher-facing review UI is owned by `documentation/architecture/changelog/reading-v2-studio-review-issues-contract.md`. Auto V4 diagnostics and publish blockers that are safe to edit in Studio must route through that normalized issue model instead of hover-only tooltip text.
...
Detailed reference: `documentation/architecture/changelog/reading-v2-material-publish-and-passage-library.md`.
