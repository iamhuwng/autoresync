...
Changelog ID: `CL-20260615-READING-V2-MATERIAL-REMOVAL-LIFECYCLE`
Moved from: `documentation/architecture/reading-v2-material-removal-lifecycle.md`
...
- `documentation/architecture/changelog/reading-v2-material-publish-and-passage-library.md`
- `documentation/architecture/changelog/reading-v2-audit-trail.md`
