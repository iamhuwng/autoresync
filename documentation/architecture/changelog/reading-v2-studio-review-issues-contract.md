...
Changelog ID: `CL-20260608-READING-V2-STUDIO-REVIEW-ISSUES-CONTRACT`
Moved from: `documentation/architecture/reading-v2-studio-review-issues-contract.md`
...
1. This contract.
2. `documentation/architecture/changelog/reading-v2-auto-v4-provider-review-contract.md` for Auto V4 handoff rules.
