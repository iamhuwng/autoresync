...
export const StudentSoloTestPage: React.FC = () => {
    ...
    // Parse location state for course material context
    const courseState = location.state as CourseLocationState | null;
    const isCourseMode = !isHomework && (courseState?.isCourseMode || false);
    const courseId = courseState?.courseId;
    const courseName = courseState?.courseName;
    ...
    }, [isHomework, homeworkId, isCourseMode, courseId, courseName, materialId]);
                ...
                <Group justify="space-between" align="flex-start">
                    <div style={{ flex: 1 }}>
                        <Group gap="xs" mb="xs">
                            ...
                            <Badge color={isHomework ? 'orange' : isCourseMode ? 'violet' : 'blue'} variant="light">
                                {isHomework ? 'Homework' : isCourseMode ? 'Course Practice' : 'Solo Practice'}
                            </Badge>
