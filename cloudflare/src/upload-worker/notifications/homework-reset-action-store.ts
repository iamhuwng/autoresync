...
export class FirebaseHomeworkResetNotificationStorage implements HomeworkResetNotificationStorage {
  ...
  retrySuppressed(): Promise<boolean> { return this.gate.isSuppressed('homework-reset'); }
  recordSuccess(at: number): Promise<void> { return this.gate.recordSuccess('homework-reset', at); }
