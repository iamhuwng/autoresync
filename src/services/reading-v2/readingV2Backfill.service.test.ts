...
const nativeComposition = (): ReadingV2FullTestComposition => ({
  ...
  passageRefs: [
    {
      ...
      materialId: readingV2Ids.readingPassageMaterialId('existing-passage'),
      ...
      ownerId: 'teacher-1',
      visibility: 'private',
      currentVersionId: readingV2Ids.snapshotVersionId('existing-snapshot'),
      testType: {
  ...
  numbering: {
    ...
    passageRanges: [{
      order: 1,
      passageMaterialId: 'existing-passage',
      snapshotVersionId: 'existing-snapshot',
