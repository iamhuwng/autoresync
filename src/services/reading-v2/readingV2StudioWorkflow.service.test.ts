...
describe('readingV2StudioWorkflow.service', () => {
  ...
  it('opens Auto V3 import candidates through the import Studio path', () => {
    const context = resolveReadingV2StudioWorkflowContext({
      ...
      initialImportCandidate: {
        ...
        rawText: [
          '## Imported Reading passage',
          '',
          'This Auto V3 passage has enough text to become an editable Reading V2 passage paragraph.',
          '',
          '#### Questions 1-1',
          'Complete the sentence.',
          '**1** imported answer',
