...
const deliveryProjection: BookRuntimeDeliveryProjection = {
  ...
  book: {
    ...
    bookMode: 'pdf',
    bookRevision: 2,
    manifestVersionId: 'manifest-runtime-v2',
  ...
  activities: [
    {
      ...
      activityVersion: 1,
      activityVersionId: 'activity-choice-v1',
      nodeKey: 'group-1',
      order: 1,
      contextMode: 'none',
    ...
    },
    {
      ...
      activityVersion: 1,
      activityVersionId: 'activity-source-v1',
      nodeKey: 'group-1',
      order: 2,
      ...
      sourceContext: {
        ...
        pageGroupKeys: ['page-group-source'],
    ...
    },
    {
      ...
      activityVersion: 1,
      activityVersionId: 'activity-long-v1',
      nodeKey: 'group-2',
      order: 3,
  ...
  activities: [
    {
      ...
      sourceContext: {
        ...
        pageGroupKeys: ['page-group-choice'],
