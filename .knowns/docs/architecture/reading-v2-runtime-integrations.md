---
title: Reading V2 Runtime Integrations
description: Reading V2 integration contract for anti-cheat, trusted submit, feedback, admin monitoring, and non-live return-path wiring.
...
Repo architecture mirror: `documentation/architecture/reading-v2-runtime-integrations.md`.
